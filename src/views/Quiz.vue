<template>
  <div id="quiz-container">
    <img id="logo-crown" src="@/assets/icon.png" alt="headsUP Crown" />
    <h1 id="logo-headline">Quiz APP</h1>
...
.divider {
  ...
  border-radius: 2px;
  box-shadow: 3px 5px 5px rgba(255, 255, 255, 0.685);
}
form {
  display: flex;
  flex-direction: row;
...
button {
  ...
  margin: 0.3rem;
  width: 47%;
  background-color: rgba(226, 220, 220, 0.63);
  border: none;
